/* [project]/node_modules/@syncfusion/ej2-base/styles/material.css [app-client] (css, ) */
@font-face {
  font-family: e-icons;
  font-style: normal;
  font-weight: normal;
...
.e-ripple-element, .e-ripple-style:after {
  ...
  -webkit-transform: scale(0);
  transform: scale(0);
  -webkit-transition: opacity, -webkit-transform cubic-bezier(0, .1, .2, 1);
  transition: opacity, -webkit-transform cubic-bezier(0, .1, .2, 1);
  transition: opacity, transform cubic-bezier(0, .1, .2, 1);
  transition: opacity, transform cubic-bezier(0, .1, .2, 1), -webkit-transform cubic-bezier(0, .1, .2, 1);
}
...
/*# sourceMappingURL=node_modules_%40syncfusion_ej2-base_styles_material_3ffd7f.css.map*/