/* [project]/node_modules/@syncfusion/ej2-navigations/styles/material.css [app-client] (css, ) */
...
@-webkit-keyframes hscroll-popup-shadow {
  0% {
    ...
    -webkit-box-shadow: 0 0 #ffffff80;
    box-shadow: 0 0 #ffffff80;
  }

  100% {
    -webkit-box-shadow: 0 0 0 200px #ffffff1f;
...
.e-hscroll.e-rtl.e-scroll-device .e-scroll-nav.e-scroll-right-nav {
  ...
  -webkit-box-shadow: 4px 0 8px #0000000f;
...
.e-hscroll .e-scroll-overlay.e-scroll-left-overlay {
  background-image: -webkit-gradient(linear, left top, right top, from(#fafafa), to(#fafafa00));
  background-image: linear-gradient(-270deg, #fafafa 0%, #fafafa00 100%);
}

.e-hscroll .e-scroll-overlay.e-scroll-right-overlay {
  background-image: -webkit-gradient(linear, left top, right top, from(#fafafa00), to(#fafafa));
  background-image: linear-gradient(-270deg, #fafafa00 0%, #fafafa 100%);
}
...
.e-hscroll .e-scroll-nav:active:after {
  -webkit-animation: .6s ease-out hscroll-popup-shadow;
...
.e-vscroll .e-scroll-nav:active:after {
  -webkit-animation: .6s ease-out vscroll-popup-shadow;
  animation: .6s ease-out vscroll-popup-shadow;
  visibility: visible;
}
...
.e-toolbar .e-hor-nav:active:after {
  -webkit-animation: .6s ease-out tbar-popup-shadow;
  animation: .6s ease-out tbar-popup-shadow;
  visibility: visible;
}
...
.e-toolbar .e-toolbar-pop {
  background: #fafafa;
  border: 1px #0000001f;
  -webkit-box-shadow: 0 2px 2px 1px #00000036;
...
.e-carousel.e-carousel-fade-animation .e-carousel-items.e-fade-in-out {
  ...
  -webkit-animation: .6s ease-in-out fade-in-out;
...
@-webkit-keyframes tbar-alt-popup-shadow {
  0% {
    border-color: #0000001f;
    -webkit-box-shadow: 0 0 #0000001f;
    box-shadow: 0 0 #0000001f;
  }

  100% {
    -webkit-box-shadow: 0 0 0 200px #0000001f;
...
.e-tab .e-tab-header.e-vertical .e-indicator {
  display: block;
  -webkit-transition: top .125s cubic-bezier(.35, 0, .25, 1), bottom .25s cubic-bezier(.35, 0, .25, 1);
...
@media screen and (width <= 480px) and (width <= 480px) {
  .e-tab.e-edge .e-tab-header .e-popup-down-icon {
    -webkit-transform: none;
    transform: none;
    -webkit-transition: none;
...
.e-tab.e-background .e-tab-header .e-hscroll:not(.e-scroll-device) .e-scroll-nav:active:after, .e-tab.e-background .e-tab-header .e-scroll-nav:active:after {
  -webkit-animation: 1s ease-out hscroll-alt-popup-shadow;
  animation: 1s ease-out hscroll-alt-popup-shadow;
}
...
.e-tab.e-background .e-tab-header .e-hor-nav:not(.e-expended-nav):active:after, .e-tab.e-background .e-tab-header .e-hor-nav:active:after {
  -webkit-animation: 1s ease-out tbar-alt-popup-shadow;
  animation: 1s ease-out tbar-alt-popup-shadow;
}
...
.e-sidebarcontainer.e-sidebar.e-over, .e-sidebarcontainer.e-sidebar.e-auto, .e-sidebarcontainer.e-sidebar.e-push, .e-sidebarcontainer.e-sidebar.e-slide + div {
  ...
  transition: margin .5s, transform .5s, -webkit-transform .5s;
}
...
.e-content-animation {
  transition: margin .5s, -webkit-transform .5s, transform .5s;
}
...
.e-appbar {
  -webkit-box-shadow: 0 2px 4px #0000001a, 0 2px 6px #00000029;
...
.e-appbar.e-horizontal-bottom {
  -webkit-box-shadow: 0 -2px 3px #0000001a, 0 -2px 6px #0003;
...
/*# sourceMappingURL=node_modules_%40syncfusion_ej2-navigations_styles_material_3ffd7f.css.map*/