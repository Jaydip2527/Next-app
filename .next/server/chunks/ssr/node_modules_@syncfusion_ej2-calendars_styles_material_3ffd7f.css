/* [project]/node_modules/@syncfusion/ej2-calendars/styles/material.css [app-client] (css, ) */
...
.e-calendar .e-zoomin {
  -webkit-animation: .3s animatezoom;
...
@media screen and (orientation: landscape) and (device-width >= 768px) {
  .e-daterangepick-mob-popup-wrap .e-daterangepicker.e-popup.e-popup-expand .e-date-range-container .e-range-header .e-model-header-wrapper .e-btn {
    font-size: 18px;
  }
}
...
/*# sourceMappingURL=node_modules_%40syncfusion_ej2-calendars_styles_material_3ffd7f.css.map*/